...
// Local Image Import
import ReactImg from '../../assets/images/Mern.jpg';

const ReactDeveloper: React.FC = () => {
    ...
    return (
        <div className="bg-white font-sans">
            {/* Header / Hero with React Background */}
            <div className="relative h-[200px] md:h-[300px] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col p-6 text-left">
                    ...
                    <div className="flex-grow flex items-center">
                        <div className="max-w-7xl mx-auto w-full">
                            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">React JS Developer</h1>
            ...
            <div className="px-6 py-12 space-y-12">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                        We are looking for a highly skilled React.js Developer to join our front-end team. Your primary focus will be on developing user interface components and implementing them following well-known React.js workflows (such as Redux or Flux). You will ensure that these components and the overall application are robust and easy to maintain. You will coordinate with the rest of the team working on different layers of the infrastructure. Therefore, a commitment to collaborative problem solving, sophisticated design, and quality product is important.
                    </p>
                </section>
                ...
                <section className="bg-white border border-gray-100 rounded-[40px] shadow-2xl overflow-hidden">
                    <div className="p-8 md:p-12 space-y-8">
                        <h2 className="text-2xl font-bold text-gray-900 text-center">Apply for React JS Developer position</h2>
