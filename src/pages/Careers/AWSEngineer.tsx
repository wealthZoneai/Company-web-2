...
const AWSEngineer: React.FC = () => {
    ...
    return (
        <div className="bg-white font-sans">
            {/* Header / Hero with AWS Background */}
            <div className="relative h-[200px] md:h-[300px] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col p-6 text-left">
                    ...
                    <div className="flex-grow flex items-center">
                        <div className="max-w-7xl mx-auto w-full">
                            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">AWS Engineer</h1>
            ...
            <div className="px-6 py-12 space-y-12">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                        We are looking for an AWS Engineer to join our cloud infrastructure team. You will be responsible for designing, building, and maintaining our cloud infrastructure on AWS. You will work closely with the development and operations teams to ensure the availability, security, and scalability of our applications and services.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <ul className="space-y-3">
                        {[
                            ...
                            "Manage and troubleshoot network and security configurations on AWS."
                        ].map((item, index) => (
                ...
                <section className="space-y-4">
                    ...
                    <ul className="space-y-3">
                        {[
                            ...
                            "Proven experience as an AWS Engineer or Cloud Architect.",
                            "In-depth knowledge of AWS services such as EC2, S3, RDS, VPC, IAM, and Lambda.",
                            "Experience with Infrastructure as Code (IaC) tools like Terraform or CloudFormation.",
                            "Familiarity with containerization and orchestration tools like Docker and Kubernetes.",
                            "Strong understanding of networking concepts (DNS, TCP/IP, VPC, Load Balancing).",
                            "AWS certification (e.g., AWS Certified Solutions Architect/SysOps Administrator) is a plus."
                        ].map((item, index) => (
                            <li key={index} className="flex items-start gap-3 text-gray-600">
                                <FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" />
                                <span>{item}</span>
                ...
                <section className="bg-white border border-gray-100 rounded-[40px] shadow-2xl overflow-hidden">
                    <div className="p-8 md:p-12 space-y-8">
                        <h2 className="text-2xl font-bold text-gray-900 text-center">Apply for AWS Engineer position</h2>
