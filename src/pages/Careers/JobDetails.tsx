...
// Local Image Import
import UIUXImg from '../../assets/images/Ourserves/Graphic.avif';
...
const JobDetails: React.FC = () => {
    ...
    return (
        <div className="bg-white font-sans">
            {/* Header / Hero with UI/UX Background */}
            <div className="relative h-[200px] md:h-[300px] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col p-6">
                    ...
                    <div className="flex-grow flex items-center">
                        <div className="w-full">
                            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">UI/UX Designer</h1>
            ...
            <div className="px-6 py-12 space-y-12">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                        Our Culture is built on a foundation of innovation, a commitment to integrity, and a drive to make a positive impact. we faster an environment where creativity thrives, and every team member is empowered to contribute their unique perspectives.
                    </p>
                </section>
                ...
                <section className="bg-white border border-gray-100 rounded-[40px] shadow-2xl overflow-hidden">
                    <div className="p-8 md:p-12 space-y-8">
                        <h2 className="text-2xl font-bold text-gray-900 text-center">Apply for UI/UX Designer position</h2>
