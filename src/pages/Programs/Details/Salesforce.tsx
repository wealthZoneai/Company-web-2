...
import { FaCheckCircle, FaClock, FaCertificate, FaLaptop, FaDownload, FaArrowLeft, FaCloud } from 'react-icons/fa';
        ...
        <div className="bg-white min-h-screen font-sans">
            <div className="bg-white border-b border-gray-100 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-gray-900">Salesforce</h1>
                            <p className="text-xs text-gray-500">Master the world's #1 CRM platform.</p>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12 space-y-12">
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold text-gray-900">What is Salesforce?</h2>
                    ...
                    <div className="md:col-span-5 space-y-8">
                        <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100">
                            ...
                            <ul className="space-y-2">
                                {['Salesforce Developer', 'Salesforce Admin', 'CRM Consultant', 'App Builder', 'Solution Architect'].map((job) => (
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['Apex', 'Visualforce', 'Lightning Web Components', 'SOQL/SOSL', 'CRM Administration', 'Process Automation'].map((skill) => (
                ...
                <ApplicationModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} courseName="Salesforce" />
            </div>
        </div>
    );
};
