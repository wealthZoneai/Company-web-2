...
import { FaCheckCircle, FaClock, FaCertificate, FaLaptop, FaDownload, FaArrowLeft, FaReact } from 'react-icons/fa';
            ...
            <div className="bg-white border-b border-gray-100 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-gray-900">MERN Stack (React JS, Node JS)</h1>
                            <p className="text-xs text-gray-500">Master the art of building modern web applications.</p>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12 space-y-12">
                <section className="space-y-4">
                    ...
                    <p className="text-gray-600 leading-relaxed max-w-4xl text-sm">
                        React JS is a powerful and widely used JavaScript library for building dynamic, interactive, and high-performance user interfaces, especially for single-page applications (SPAs). It enables developers to create reusable UI components that efficiently update and render as application data changes, improving both performance and user experience.
                    </p>
                </section>
                    ...
                    <div className="md:col-span-5 space-y-8">
                        <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100">
                            ...
                            <ul className="space-y-2">
                                {['MERN Stack Developer', 'Frontend Developer', 'Node.js Developer', 'Full Stack Engineer', 'React Developer'].map((job) => (
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['MongoDB', 'Express.js', 'React.js', 'Node.js', 'Redux', 'JavaScript', 'REST APIs'].map((skill) => (
                ...
                <ApplicationModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} courseName="MERN Stack" />
            </div>
        </div>
    );
};
