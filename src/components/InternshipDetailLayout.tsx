...
import ProgramComparisonTable from '../pages/Programs/ProgramComparisonTable';
import ApplicationModal from './ApplicationModal';
import SubNavbar from './intershipNavbar';
import InternshipFooter from './intershipFooter';

interface InternshipDetailLayoutProps {
    title: string;
    subtitle: string;
...
const InternshipDetailLayout: React.FC<InternshipDetailLayoutProps> = ({
    title,
    subtitle,
    icon,
    introTitle,
        ...
        <div className="bg-white min-h-screen font-sans">
            ...
            <div className="bg-white border-b border-gray-100 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
                    <Link to="/internship" className="text-gray-500 hover:text-blue-600 transition-colors">
                        <FaArrowLeft />
                    </Link>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12 space-y-12">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold text-gray-900">{introTitle}</h2>
                    <div className="text-gray-600 leading-relaxed max-w-4xl text-sm">
                        {introContent}
                    </div>
                </section>
                ...
                <div className="grid md:grid-cols-12 gap-8">
                    ...
                    <div className="md:col-span-7 space-y-8">
                        {/* Internship Highlights - BLUE THEME */}
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-3 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500">Learn at your own pace with 24/7 access to course materials.</p>
                                    </div>
                                </li>
                                <li className="flex gap-3 items-start">
                                    <FaCheckCircle className="text-green-500 mt-1 shrink-0" />
                                ...
                                <li className="flex gap-3 items-start">
                                    <FaCheckCircle className="text-green-500 mt-1 shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-gray-900 text-sm">EmployID</h4>
                                        <p className="text-xs text-gray-500">Interns receive a company email ID for professional communication.</p>
                                    </div>
                                </li>
                                <li className="flex gap-3 items-start">
                                    <FaCheckCircle className="text-green-500 mt-1 shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-gray-900 text-sm">OfficialEmail</h4>
                                        <p className="text-xs text-gray-500">Interns receive a company email ID for professional communication.</p>
                                    </div>
                                </li>
                                <li className="flex gap-3 items-start">
                                    <FaCheckCircle className="text-green-500 mt-1 shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-gray-900 text-sm">HRMS Access</h4>
                                        <p className="text-xs text-gray-500">Complete access to the HRMS portal for attendance and internship details.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <ApplicationModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} courseName={courseName} />
            </div>
            <InternshipFooter />
        </div>
    );
...
export default InternshipDetailLayout;
